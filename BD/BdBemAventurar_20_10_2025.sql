...
CREATE TABLE IF NOT EXISTS "Eventos" (
	...
	FOREIGN KEY INDEX "FK_Eventos_Categorias" ("CategoriaID"),
	PRIMARY KEY ("EventoID"),
	CONSTRAINT "FK_Eventos_Categorias" FOREIGN KEY ("CategoriaID") REFERENCES "Evento_categorias" ("CategoriaID") ON UPDATE NO_ACTION ON DELETE NO_ACTION
);

-- Copiando dados para a tabela BemAventurar.Eventos: -1 rows
DELETE FROM "Eventos";
/*!40000 ALTER TABLE "Eventos" DISABLE KEYS */;
/*!40000 ALTER TABLE "Eventos" ENABLE KEYS */;

-- Copiando estrutura para tabela BemAventurar.Evento_categorias
CREATE TABLE IF NOT EXISTS "Evento_categorias" (
	"CategoriaID" INT NOT NULL,
	"Nome_Categoria" NVARCHAR(150) NOT NULL COLLATE 'Latin1_General_CI_AS',
	"CriadoEm" DATETIME NULL DEFAULT 'getdate()',
	PRIMARY KEY ("CategoriaID")
);

-- Copiando dados para a tabela BemAventurar.Evento_categorias: -1 rows
DELETE FROM "Evento_categorias";
/*!40000 ALTER TABLE "Evento_categorias" DISABLE KEYS */;
/*!40000 ALTER TABLE "Evento_categorias" ENABLE KEYS */;
...
-- Copiando dados para a tabela BemAventurar.Evento_faqs: -1 rows
...
-- Copiando dados para a tabela BemAventurar.Evento_fotos: -1 rows
...
-- Copiando dados para a tabela BemAventurar.Evento_itinerarios: -1 rows
...
-- Copiando estrutura para tabela BemAventurar.Evento_videos
CREATE TABLE IF NOT EXISTS "Evento_videos" (
	"VideoID" INT NOT NULL,
	"EventoID" INT NOT NULL,
	"nome_video" NVARCHAR(150) NOT NULL COLLATE 'Latin1_General_CI_AS',
	"Link_video" NVARCHAR(150) NOT NULL COLLATE 'Latin1_General_CI_AS',
	"CriadoEm" DATETIME NULL DEFAULT 'getdate()',
	FOREIGN KEY INDEX "FK__Evento_vi__Criad__03F0984C" ("EventoID"),
	PRIMARY KEY ("VideoID"),
	CONSTRAINT "FK__Evento_vi__Criad__03F0984C" FOREIGN KEY ("EventoID") REFERENCES "Eventos" ("EventoID") ON UPDATE NO_ACTION ON DELETE NO_ACTION
);

-- Copiando dados para a tabela BemAventurar.Evento_videos: -1 rows
DELETE FROM "Evento_videos";
/*!40000 ALTER TABLE "Evento_videos" DISABLE KEYS */;
/*!40000 ALTER TABLE "Evento_videos" ENABLE KEYS */;
...
-- Copiando dados para a tabela BemAventurar.Inscricoes: -1 rows
...
-- Copiando dados para a tabela BemAventurar.Logs: -1 rows
DELETE FROM "Logs";
...
-- Copiando dados para a tabela BemAventurar.Modulos: -1 rows
DELETE FROM "Modulos";
...
-- Copiando dados para a tabela BemAventurar.Permissoes: -1 rows
...
-- Copiando dados para a tabela BemAventurar.Usuarios: -1 rows
