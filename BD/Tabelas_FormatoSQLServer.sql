...
CREATE TABLE Evento_categorias (
    ...
    Nome_Categoria NVARCHAR(150) NOT NULL,
    CriadoEm DATETIME DEFAULT GETDATE()
);
...
-- Adiciona a nova coluna CategoriaID na tabela Eventos
ALTER TABLE Eventos
ADD CategoriaID INT;

-- Cria a chave estrangeira ligando Eventos → Evento_Categorias
ALTER TABLE Eventos
ADD CONSTRAINT FK_Eventos_Categorias
FOREIGN KEY (CategoriaID)
REFERENCES Evento_Categorias (CategoriaID);
